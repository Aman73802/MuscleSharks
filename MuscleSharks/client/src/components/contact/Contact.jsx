                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    <div>
                      ...
                      <div className="mt-2.5 relative">
                        <input
                          ...
                          className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-teal-600 caret-teal-600"
                        />
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-2.5 relative">
                        <textarea
                          ...
                          className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md resize-y focus:outline-none focus:border-teal-600 caret-teal-600"
                          rows="4"
                        ></textarea>
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                      <button
                        ...
                        className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-teal-600 border border-transparent rounded-md focus:outline-none hover:bg-teal-900 focus:bg-teal-300"
                      >
                        Send
                      </button>
                    </div>
