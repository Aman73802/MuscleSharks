...
export default function NavbarComp() {
  ...
  return (
    <>
      <Navbar className="bg-teal-600" shouldHideOnScroll>
        ...
        <NavbarContent className="hidden sm:flex gap-4" justify="center">
          <NavbarBrand>
            <Link
              color="foreground"
              className="navbar-brand text-3xl mx-5 text-white font-semibold"
              to="/"
            >
              MuscleSharks
            </Link>
      ...
      <div className="lg:block md:block hidden sm:hidden max-sm:hidden icons lg:p-5 bg-teal-200">
