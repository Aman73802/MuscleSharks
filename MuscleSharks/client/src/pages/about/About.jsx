          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <span className="block mb-2 text-lg font-semibold text-teal-600">
                  Why Choose Us
                </span>
                <h2 className="mb-8 text-3xl font-bold text-teal-600 sm:text-4xl">
                ...
                <p className="mb-8 text-base text-body-color">
                  {showFullText ? (
                    ...
                    <>
                      Welcome to Muscle Sharks, your ultimate destination for top-quality fitness supplements in Ludhiana. We are proud to offer a wide range of supplements designed to support your fitness goals, whether you’re looking to build muscle, enhance performance, improve recovery, or manage weight. With our commitment to excellence and passion for fitness, we strive to provide you with the best products and service.{' '}
                      <span className="text-teal-600 cursor-pointer" onClick={toggleReadMore}>
                        Read More
                      </span>
                    </>
                  )}
                ...
                <Link
                  to="/"
                  className="inline-flex items-center justify-center px-10 py-4 text-base font-normal text-center text-white rounded-lg bg-teal-600 hover:bg-opacity-90 lg:px-8 xl:px-10"
                >
                  Get Started
                </Link>
              </div>
