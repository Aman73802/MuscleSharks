        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              <span className="mb-2 block text-lg font-semibold text-teal-600">
                Our Services
              </span>
...
controls
      ...
      ></video>
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            title="Muscle Sharks: Elevate Your Fitness"
            details="Quality, service, style - that's what we stand for at Muscle Sharks. Join us on a fitness journey that redefines the standard."
            icon={
              <svg
                width="36"
          ...
          />
          <ServiceCard
            title="Energizing Aesthetics"
            details="Crafted with precision and backed by quality. Our supplements are designed for those who demand the best. Welcome to a world of excellence in fitness."
            icon={
              <svg
                width="36"
                height="36"
          ...
          />
          <ServiceCard
            title="Power Up Your Strength Journey"
            details="Our products are tailored for those who demand quality, speed, and excellence in their fitness pursuits. Experience the difference with us."
            icon={
              <svg
                width="36"
                height="36"
          ...
          />
          <ServiceCard
            title="Where Quality Meets Style: Elevate Your Fitness."
            details="Unleash your potential with MuscleSharks. Elevate your fitness journey with top-tier supplements curated for discerning individuals. Experience quality, service, and aesthetics like never before. Your path to peak performance starts here.."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="At MuscleSharks, we take pride in serving individuals who demand the best - exceptional quality, unparalleled service, and an unwavering commitment to aesthetics. Experience fitness, personalized just for you."
            icon={
              <svg
                width="36"
                height="36"
    ...
    <>
      <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10">
          <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-teal-600">
            {icon}
          </div>
